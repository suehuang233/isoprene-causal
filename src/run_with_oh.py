...
OUTPUT_DIR = "./isoprene_dowhy_causaleffect"
...
def main():
    ...
    nodes_label = ['RH', 'Temp', 'Radiation', 'u', 'v', 'Oxides', 'OH', 'Toluene', 'leaf_stage', 'U', 'Isoprene']
    nodes =       ['A',   'B',      'C',         'D', 'E', 'F',   'G',   'H',       'I',         'U',   'Y']

    edges = [
        # Direct to outcome
        'AY', 'BY', 'CY', 'DY', 'EY', 'FY', 'HY', 'GY', 'IY',
        'AF', 'AG', 'AH',   # RH -> Oxides / OH / Toluene
        'BA', 'BH', 'BF', 'BG',   # Temp -> RH / Toluene / Oxides / OH
        'CH', 'CF', 'CG',   # Radiation -> Toluene / Oxides / OH
        'DF', 'DG', 'DH',   # u -> Oxides / OH / Toluene
        'EF', 'EG', 'EH',   # v -> Oxides / OH / Toluene
        'GF', 'GH',         # OH -> Oxides / Toluene
        'HF',               # Toluene -> Oxides
        'UY'
    ]
    ...
    if PLOT_DAG:
        plot_global_dag(gml_string, os.path.join(OUTPUT_DIR, "Global_DAG_with_OH.png"))
    ...
    for treat in run_list:
        ...
        nodes_label_model = ['RH', 'Temp', 'Radiation', 'u', 'v', 'Oxides', 'OH', 'Toluene', 'leaf_stage', 'U', 'Isoprene']
